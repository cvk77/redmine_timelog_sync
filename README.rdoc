...
so I created a little Redmine plugin automatically creates calendar entries on our CalDAV-Server in TimeLog's format, as soon as efforts are added to Redmine.
